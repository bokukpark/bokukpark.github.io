...
image::assets/img/2020-04-17-Component-Diagram/Component-Diagram.png[caption="컴포넌트 다이어그램"]
...
image::/assets/img/2020-04-17-Component-Diagram/Component.png[caption="컴포넌트"]
